      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-center gap-2">
        <div className="flex items-center gap-2 overflow-x-auto">
          <div className="flex gap-2 flex-nowrap">
            ...
            {/* ZOOM PERCENTAGE */}
            <span className="text-white text-sm w-10 h-10 flex items-center justify-center">
              {Math.round(zoom * 100)}%
            </span>
            ...
            <button
              ...
              onClick={() => {
                downloadImage();
                setToolMode("draw");
                trackClick("visit_link", "toolbar_save");
                window.open("https://your-get-started-url.com", "_blank", "noopener,noreferrer");
              }}
